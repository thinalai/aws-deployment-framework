...
stub_failed_pipeline_event = {
    'Records': [{
        ...
        'Sns': {
            ...
            'TopicArn': 'arn:aws-cn:sns:eu-central-1:9999999:adf-pipeline-sample-vpc-PipelineSNSTopic-example',
            'Subject': None,
            'Message': '{"version":"0","id":"1","detail-type":"CodePipeline Pipeline Execution State Change","source":"aws.codepipeline","account":"2","time":"3000-03-10T11:09:38Z","region":"eu-central-1","resources":["arn:aws-cn:codepipeline:eu-central-1:999999:adf-pipeline-sample-vpc"],"detail":{"pipeline":"adf-pipeline-sample-vpc","execution-id":"1","state":"FAILED","version":9.0}}',
